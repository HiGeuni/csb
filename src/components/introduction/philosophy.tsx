    ...
    <>
      <ul>
        ...
        <ListComponent
          ...
          delay='600'
        />
        <ListComponent content='다양한 연구자 요구에 200% 이상의 만족을 이끌어내는 기업' delay='900' />
        <ListComponent content='자신의 가치가 존중 받고, 그 가치가 행복을 가져다 주는 기업' delay='1200' />
        <ListComponent
          content='새로운 도전에 주저함 없이 실패/좌절의 발돋움으로 더욱 전진해 나가는 기업'
          delay='1500'
        />
        <ListComponent
