    ...
    <div className='bg-primary text-white h-[300px] md:h-44 px-12 pt-6 relative -translate-y-full'>
      <div className='w-full mb-4 bg-gray-500 md:flex md:justify-between text-sm md:px-8'>
        ...
        <div className='text-xs'>
          <div className='pt-8 md:pt-0 text-sm font-bold mb-4'>CONTACT US</div>
          <div>
      ...
      <hr className='my-0' />
      <div className='md:px-8 md:flex justify-end text-sm py-2'>ⓒ 2022 PennBIT, All rights reserved</div>
    </div>
  );
};
